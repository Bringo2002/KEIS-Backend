import { pgTable, pgEnum, text, integer, real, boolean, timestamp, uniqueIndex, index, primaryKey, } from 'drizzle-orm/pg-core';
...
export const indicatorDataPoints = pgTable('indicator_data_points', {
    id: text('id')
        .primaryKey()
        .$defaultFn(() => createId()),
...
export const indicatorPlayers = pgTable('indicator_players', {
    indicatorId: text('indicator_id')
        .notNull()
        .references(() => macroIndicators.id),
    playerId: text('player_id')
