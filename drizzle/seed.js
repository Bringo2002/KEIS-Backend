...
import { players, economicEvents, macroIndicators, indicatorDataPoints, relationships, eventPlayers, } from './schema';
...
const PLAYERS = [
    ...
    },
    {
        ...
        hq: 'Nairobi',
        ownership: 'Government of Kenya (100%)',
        description: 'Regulates and develops Kenya\'s capital markets including the Nairobi Securities Exchange, investment banks, fund managers, collective investment schemes, and REITs. The CMA approves IPOs, bond issuances, and takeovers. Has been actively pushing for more listings, a deeper corporate bond market, and a REIT framework to mobilise real estate investment.',
        keyFacts: [
    ...
    },
    {
        ...
        description: 'National tax collection agency responsible for collecting VAT, corporate tax, PAYE, excise duties, and customs. Has been under intense pressure to meet ambitious revenue targets set by National Treasury. Rolling out eTIMS (electronic tax invoice management system) to seal VAT leakage. Customs revenue is heavily tied to Mombasa Port throughput.',
        keyFacts: [
    ...
    },
    {
        ...
        hq: 'Nairobi',
        ownership: 'Government of Kenya (100%)',
        description: 'Enforces competition law, reviews mergers and acquisitions, and investigates anti-competitive practices. Blocked the Airtel-Telkom merger. Has been increasingly active in reviewing digital market dominance, particularly Safaricom\'s M-Pesa market share.',
        keyFacts: [
    ...
    },
    {
        ...
        description: 'Kenya\'s primary securities exchange. Hosts equity, debt, and derivatives markets. Self-listed since 2014. The NSE 20 Share Index and NSE All-Share Index (NASI) are the main benchmarks. Equity and Safaricom dominate by market cap and trading volume. Has been working on derivatives and commodities exchange products.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~3,000',
        marketCap: 'KES 16B',
        description: 'Formerly Barclays Bank of Kenya — rebranded to Absa in 2020 following Barclays PLC selling its African operations to Absa Group. Strong in retail banking, mortgage finance, and trade finance. Part of the pan-African Absa Group which also operates in 12 other African countries. Retains strong corporate client base from legacy Barclays relationships.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~1,800',
        marketCap: 'KES 23B',
        description: 'Oldest bank in Kenya. Part of Standard Chartered PLC, a major global bank. Focuses on corporate, institutional, and high-net-worth clients. Significant player in foreign currency transactions, trade finance, and correspondent banking. Known for the highest margins in Kenya\'s banking sector due to premium client focus.',
        keyFacts: [
    ...
    // ── TIER 2 BANKS ─────────────────────────────────────────────────────────
    {
        ...
        employees: '~2,500',
        marketCap: 'KES 9B',
        description: 'Mid-tier bank with deep roots in East Africa\'s Asian business community. Part of the Aga Khan Development Network (AKDN). Operates in Kenya, Uganda, Tanzania, and Burundi. Significant in trade finance for SMEs. The Aga Khan\'s AKFED is the controlling shareholder alongside the broader AKDN ecosystem which includes Jubilee Insurance and various infrastructure investments.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~2,200',
        marketCap: 'KES 11B',
        description: 'Mid-tier bank with strong roots in Kenya\'s Asian business community. Regional presence in Rwanda, Tanzania, Uganda, and Mauritius. British International Investment (formerly CDC Group, the UK\'s development finance institution) is a significant shareholder. Acquired Bank One in Mauritius, expanding into Indian Ocean market. Strong in trade finance and SME banking.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~2,000',
        marketCap: 'KES 4B',
        description: 'Mid-tier bank targeting retail, SME, and agricultural customers. Formerly Family Finance Building Society before converting to a full bank. Strong in SME lending and agribusiness finance. Has been expanding its digital banking footprint via Paybill and mobile banking.',
        keyFacts: [
    ...
    },
    {
        ...
        revenue: 'KES 8B (2023)',
        employees: '~500',
        description: 'State-owned national oil company. Operates downstream retail fuel stations (National Oil brand), upstream exploration activities, and strategic petroleum reserves management. Has been commercially weak — unable to compete effectively with private operators like TotalEnergies and Rubis. Government uses NOCK to regulate fuel prices.',
        keyFacts: [
    ...
    // ── PARASTATALS & INFRASTRUCTURE ─────────────────────────────────────────
    {
        ...
        revenue: 'KES 28B (2023)',
        employees: '~4,500',
        description: 'Manages the Port of Mombasa — East and Central Africa\'s largest port. Critical node for regional trade. Handles imports for Kenya, Uganda, Rwanda, DRC, South Sudan, and Burundi. The Port of Mombasa is in direct competition with Dar es Salaam (Tanzania) for regional hinterland cargo. Lamu Port South Sudan Ethiopia Transport (LAPSSET) corridor is a major new infrastructure project under KPA oversight.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~500',
        marketCap: 'KES 32B',
        description: 'Kenya\'s only significant tobacco manufacturer. Produces Sportsman, Safari, Rooster, and premium international brands. Buys Kenyan tobacco leaf from smallholder farmers in Western Kenya. One of NSE\'s highest dividend-yielding stocks. BAT Kenya is also a regional export hub for East Africa.',
        keyFacts: [
    ...
    // ── INSURERS ─────────────────────────────────────────────────────────────
    {
        ...
        employees: '~2,000',
        marketCap: 'KES 14B',
        description: 'Largest insurer in East Africa. Part of the Aga Khan Development Network (AKDN). Operates in Kenya, Uganda, Tanzania, Burundi, and Mauritius. Offers life, general, and health insurance. Sold its general insurance business to Allianz SE in 2021 while retaining life and health. AKFED connection links it to Jubilee Bank, DTB, and other AKDN entities in Kenya.',
        keyFacts: [
    ...
    },
    {
        ...
        employees: '~1,200',
        marketCap: 'KES 5B',
        description: 'Insurance arm of Kenya\'s co-operative movement. The co-operative sector owns majority stake, mirroring the Co-operative Bank structure. Provides insurance to co-operative societies, SACCO members, and agricultural communities. Regional presence in Uganda, South Sudan, and Malawi.',
        keyFacts: [
...
const EVENTS = [
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'NEGATIVE',
        sectors: ['BANKING', 'REAL_ESTATE', 'MANUFACTURING'],
        source: 'CBK Monetary Policy Committee',
        sourceUrl: 'https://www.centralbank.go.ke',
        isAiExtracted: false,
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'NEGATIVE',
        sectors: ['BANKING', 'ENERGY', 'TRANSPORT', 'MANUFACTURING'],
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'NEGATIVE',
        sectors: ['GOVERNMENT', 'BANKING', 'TELECOMMUNICATIONS'],
        source: 'Multiple',
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'POSITIVE',
        sectors: ['TELECOMMUNICATIONS', 'FINTECH'],
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'NEUTRAL',
        sectors: ['TRANSPORT', 'ENERGY', 'GOVERNMENT'],
    ...
    },
    {
        ...
        impact: 'HIGH',
        impactType: 'POSITIVE',
        sectors: ['BANKING', 'FINTECH', 'TELECOMMUNICATIONS'],
...
const RELATIONSHIPS = [
    ...
    { id: 'rel-cbk-kcb', sourceId: 'player-cbk', targetId: 'player-kcb', type: 'REGULATORY', label: 'CBK supervises KCB as Tier 1 bank', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cbk-equity', sourceId: 'player-cbk', targetId: 'player-equity', type: 'REGULATORY', label: 'CBK supervises Equity Group', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cbk-coop', sourceId: 'player-cbk', targetId: 'player-cooperative', type: 'REGULATORY', label: 'CBK supervises Co-op Bank', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cbk-ncba', sourceId: 'player-cbk', targetId: 'player-ncba', type: 'REGULATORY', label: 'CBK supervises NCBA Group', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cbk-safaricom', sourceId: 'player-cbk', targetId: 'player-safaricom', type: 'REGULATORY', label: 'CBK regulates M-Pesa under NPS Act', weight: 8, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cma-nse', sourceId: 'player-cma', targetId: 'player-nse', type: 'REGULATORY', label: 'CMA licenses and oversees NSE', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cma-kcb', sourceId: 'player-cma', targetId: 'player-kcb', type: 'REGULATORY', label: 'CMA regulates KCB as NSE listed entity', weight: 7, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-ca-safaricom', sourceId: 'player-ca', targetId: 'player-safaricom', type: 'REGULATORY', label: 'CA regulates Safaricom telecoms licence', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-ca-airtel', sourceId: 'player-ca', targetId: 'player-airtel', type: 'REGULATORY', label: 'CA regulates Airtel Kenya licence', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-ca-telkom', sourceId: 'player-ca', targetId: 'player-telkom', type: 'REGULATORY', label: 'CA regulates Telkom Kenya licence', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-cak-airtel-telkom', sourceId: 'player-cak', targetId: 'player-airtel', type: 'REGULATORY', label: 'CAK blocked Airtel-Telkom merger 2019', weight: 8, direction: 'UNIDIRECTIONAL' },
    // Ownership / subsidiary
    { id: 'rel-kcb-nbk', sourceId: 'player-kcb', targetId: 'player-nbk', type: 'OWNERSHIP', label: 'KCB owns NBK 100% since 2019', weight: 10, direction: 'UNIDIRECTIONAL' },
    // Partnerships / JVs
    { id: 'rel-safaricom-ncba-mshwari', sourceId: 'player-safaricom', targetId: 'player-ncba', type: 'PARTNERSHIP', label: 'M-Shwari JV — digital savings and lending', weight: 9, direction: 'BIDIRECTIONAL' },
    { id: 'rel-safaricom-kcb-mpesa', sourceId: 'player-safaricom', targetId: 'player-kcb', type: 'PARTNERSHIP', label: 'KCB M-Pesa JV — mobile lending product', weight: 8, direction: 'BIDIRECTIONAL' },
    // Competitors
    { id: 'rel-safaricom-airtel-comp', sourceId: 'player-safaricom', targetId: 'player-airtel', type: 'COMPETITOR', label: 'Competitors in mobile voice, data, money', weight: 9, direction: 'BIDIRECTIONAL' },
    { id: 'rel-safaricom-telkom-comp', sourceId: 'player-safaricom', targetId: 'player-telkom', type: 'COMPETITOR', label: 'Competitors in enterprise telecoms', weight: 6, direction: 'BIDIRECTIONAL' },
    { id: 'rel-airtel-telkom-comp', sourceId: 'player-airtel', targetId: 'player-telkom', type: 'COMPETITOR', label: 'Competitors — proposed merger blocked', weight: 7, direction: 'BIDIRECTIONAL' },
    { id: 'rel-kcb-equity-comp', sourceId: 'player-kcb', targetId: 'player-equity', type: 'COMPETITOR', label: 'Direct competitors for largest bank title', weight: 9, direction: 'BIDIRECTIONAL' },
    // Supply chain / debt
    { id: 'rel-kengen-kplc', sourceId: 'player-kengen', targetId: 'player-kplc', type: 'SUPPLY_CHAIN', label: 'KenGen sells ~70% of electricity to KPLC via PPAs', weight: 10, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-kplc-treasury', sourceId: 'player-kplc', targetId: 'player-treasury', type: 'OWNERSHIP', label: 'GoK owns ~51.7% of KPLC', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-kengen-treasury', sourceId: 'player-kengen', targetId: 'player-treasury', type: 'OWNERSHIP', label: 'GoK owns ~70% of KenGen', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-kq-treasury', sourceId: 'player-kq', targetId: 'player-treasury', type: 'OWNERSHIP', label: 'GoK owns ~48.9% of Kenya Airways', weight: 9, direction: 'UNIDIRECTIONAL' },
    { id: 'rel-kpc-treasury', sourceId: 'player-kpc', targetId: 'player-treasury', type: 'OWNERSHIP', label: 'GoK owns 100% of KPC', weight: 10, direction: 'UNIDIRECTIONAL' },
    // AKDN ecosystem
    { id: 'rel-dtb-jubilee-akdn', sourceId: 'player-dtb', targetId: 'player-jubilee', type: 'PARTNERSHIP', label: 'Both part of Aga Khan Development Network', weight: 7, direction: 'BIDIRECTIONAL' },
    // Co-op movement
    { id: 'rel-coop-cic', sourceId: 'player-cooperative', targetId: 'player-cic', type: 'PARTNERSHIP', label: 'Co-operative movement controls both via Co-op Holdings', weight: 8, direction: 'BIDIRECTIONAL' },
    // IMF / Treasury
    { id: 'rel-imf-treasury', sourceId: 'player-imf', targetId: 'player-treasury', type: 'DEBT', label: 'IMF ECF/EFF program ~$2.34B — conditionality relationship', weight: 9, direction: 'BIDIRECTIONAL' },
    { id: 'rel-worldbank-treasury', sourceId: 'player-worldbank', targetId: 'player-treasury', type: 'DEBT', label: 'World Bank portfolio ~$7B in Kenya', weight: 9, direction: 'BIDIRECTIONAL' },
];
// ─── SEED FUNCTION ────────────────────────────────────────────────────────────
async function seed() {
