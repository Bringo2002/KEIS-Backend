import { db } from '../db'
import { players, economicEvents, eventPlayers } from '../../drizzle/schema'
import { eq, desc, gte } from 'drizzle-orm'
import { client } from './client'
import { ProfileUpdateResult } from '../types'

export class ProfileUpdater {
  static async updateProfile(playerId: string): Promise<ProfileUpdateResult> {
    // Get player
